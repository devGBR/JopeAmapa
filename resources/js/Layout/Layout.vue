<template>
    <v-app>
        <v-layout style="background-color: #3e6d0687; z-index: 5 !important;">
            ...
            <v-main class="pt-0 overflow-y-auto" style="z-index: 5 !important;">
                <slot />

                <v-footer class="w-100 bg-light-green-darken-4 rounded py-6 mt-9" height="300" style="box-sizing: border-box;">
                        ...
                        <section class="w-100 h-100 d-flex">
                            ...
                            <section class=" w-50 d-flex">
                                ...
                                <v-list density="compact" class="bg-transparent mr-10">
                                    <v-list-subheader class="text-white" style="font-weight: 600;">SIGA-NOS</v-list-subheader>
